        ...
        <div className="createass">
            ...
            <div className="container create-contents">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="form-row  createform">
                        <div className="form-group col-md-6 create-form">
                            <input className="createfile" id="file" type="file" name="create_url" accept="pdf" onChange={uploadFile} />
                            <label for="file"><img src={Sign} alt="createapp-icon" /> Choose file </label>
                        </div>
                        <div className="form-group col-md-6 createlink">
                            <label>Link</label>
                            <input
                        ...
                        <div className="form-group col-md-6 createdate">
                        ...
                        <div className="form-group col-md-6 createbatch">
                        ...
                        <div className="col-md-12 col-md-offset-3 instruction">
